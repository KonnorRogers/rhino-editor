...
export class TipTapElement extends LitElement {
  ...
  isDisabled(action: string, ...args: any[]) {
    ...
    if (
      ["toggleBold", "toggleStrike", "toggleItalic", "setLink"].includes(action)
    ) {
  ...
  run(action: string, ...args: any[]) {
    if (this.isDisabled(action, ...args)) {
      return;
    }
  ...
  toolbarButtonParts<T extends string>(
    actionName: T,
    ...args: any[]
  ): ToolbarButton<T> {
  ...
  can(action: string, ...args: any[]): boolean {
    // @ts-expect-error
    return this.editor != null && this.editor.can()[action]?.(...args);
  }
  ...
  renderToolbar() {
    ...
    >
      <button
        ...
        " " +
        this.disabledButton("toggleBold")}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleItalic")}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleStrike")}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleHeading", { level: 1 })}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleBlockquote")}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleCode")}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleBulletList")}
      ...
      <button
        ...
        " " +
        this.disabledButton("toggleOrderedList")}
      ...
      >
        <role-tooltip id="ordered-list" hoist
          >${config.orderedList}</role-tooltip
        >
        ${this.icons.numbers}
      </button>
    ...
    >
      <div class="link-dialog__container">
        ...
        <div class="link-dialog__buttons">
          <button class="link-dialog__button" @click=${this.addLink}>
            ${config.linkDialogLink}
          </button>
          <button
